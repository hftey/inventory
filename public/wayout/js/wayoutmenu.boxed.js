...
$( window ).resize(function() {
  ...
  offset2 = $('.menu-bg-boxed').offset(); // Wayout menu absolute offset acc.to document
  ...
  $(".top-nav > ul > li.fw").each(function() {
    ...
    $(this).hover(function() {
      ...
      fwdiv.css( 'width', '1200px' );
      fwdiv.css( 'left', -offset.left+offset2.left);
...
$(document).ready(function(){
  ...
  $(".top-nav > ul > li.fw").each(function() {
    ...
    $(this).hover(function() {
      ...
      fwdiv.css( 'width', '1200px' );
      if (is_chrome) {
        fwdiv.css( 'left', -offset.left+offset2.left-12);
      } else {
        fwdiv.css( 'left', -offset.left+offset2.left-8);
