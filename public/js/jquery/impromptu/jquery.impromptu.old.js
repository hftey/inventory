...
(function($) {
	$.prompt = function(message, options) {
		...
		var ie6		= ($.browser.msie && parseInt($.browser.version) < 7 && !window["XMLHttpRequest"]);
		...
		$.each(message,function(statename,stateobj){
			...
			states += '<div id="'+ options.prefix +'_state_'+ statename +'" class="'+ options.prefix + '_state" style="display:none;"><div class="'+ options.prefix +'message"><div class="'+stateobj.icon+'" style="float:left;"></div><div style="float:left;">' + stateobj.html +'</div></div><div class="'+ options.prefix +'buttons">';
