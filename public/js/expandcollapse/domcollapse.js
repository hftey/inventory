...
dc={
	...
	/*
	PREVIOUSLY THE 2 LINE WERE AS THE FOLLOWING (ON LOAD THE PAGE THE CONTENT WAS SHOWN), I CHANGED ACCORDNING TO MY REQUIRMENT. LIYAJ 26MAR08
	hideClass:'hide',
	showClass:'show',
	*/
	...
	*/
	...
	init:function(e){
		...
		//dc.tempLink.appendChild(document.createElement('img')); // COMMNETED BY LIYAJ, NO NEED OF IMAGE ARRAOW - LIYAJ 26MAR08
	...
	makeTrigger:function(o,e){
		...
		if(!dc.cssjs('check',o,dc.triggeropen)){
			...
			//tl.getElementsByTagName('img')[0].setAttribute('src',dc.closedPic); // COMMNETED BY LIYAJ, NO NEED OF IMAGE ARRAOW - LIYAJ 26MAR08
			//tl.getElementsByTagName('img')[0].setAttribute('alt',dc.closedAlt); // COMMNETED BY LIYAJ, NO NEED OF IMAGE ARRAOW - LIYAJ 26MAR08
			o.setAttribute('title',dc.closedAlt);
		}else{
			dc.cssjs('add',tohide,dc.showClass);
			//tl.getElementsByTagName('img')[0].setAttribute('src',dc.openPic); // COMMNETED BY LIYAJ, NO NEED OF IMAGE ARRAOW - LIYAJ 26MAR08
			//tl.getElementsByTagName('img')[0].setAttribute('alt',dc.openAlt); // COMMNETED BY LIYAJ, NO NEED OF IMAGE ARRAOW - LIYAJ 26MAR08
	...
	*/
	addCollapse:function(e){
		...
		if(dc.uniqueCollapse && dc.currentOpen){
			//dc.currentOpen.getElementsByTagName('img')[0].setAttribute('src',dc.closedPic); // COMMNETED BY LIYAJ, NO NEED OF IMAGE ARRAOW - LIYAJ 26MAR08
			//dc.currentOpen.getElementsByTagName('img')[0].setAttribute('alt',dc.closedAlt); // COMMNETED BY LIYAJ, NO NEED OF IMAGE ARRAOW - LIYAJ 26MAR08
		...
		if(o.tohide){
			if(dc.cssjs('check',o.tohide,dc.hideClass)){
				//o.getElementsByTagName('img')[0].setAttribute('src',dc.openPic); // COMMNETED BY LIYAJ, NO NEED OF IMAGE ARRAOW - LIYAJ 26MAR08
				//o.getElementsByTagName('img')[0].setAttribute('alt',dc.openAlt); // COMMNETED BY LIYAJ, NO NEED OF IMAGE ARRAOW - LIYAJ 26MAR08
				o.setAttribute('title',dc.openAlt);
				dc.cssjs('swap',o.tohide,dc.hideClass,dc.showClass);
				dc.cssjs('add',o,dc.triggeropen);
				dc.cssjs('remove',o,dc.trigger);
			}else{
				//o.getElementsByTagName('img')[0].setAttribute('src',dc.closedPic); // COMMNETED BY LIYAJ, NO NEED OF IMAGE ARRAOW - LIYAJ 26MAR08
				//o.getElementsByTagName('img')[0].setAttribute('alt',dc.closedAlt); // COMMNETED BY LIYAJ, NO NEED OF IMAGE ARRAOW - LIYAJ 26MAR08
				o.setAttribute('title',dc.closedAlt);
